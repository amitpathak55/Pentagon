...
def report(request):
    ...
    if request.GET.get('full_name'):
        ...
        students = students.filter(
            Q(first_name__icontains=request.GET.get('full_name')) |
            Q(middle_name__icontains=request.GET.get('full_name')) |
            Q(last_name__icontains=request.GET.get('full_name')) 
        )
    ...
    if request.GET.get('euid'):
        filtered = True
        students = students.filter(
            euid=request.GET.get('euid')
        )
    ...
    if request.GET.get('citizenship'):
        filtered = True
        students = students.filter(
            citizenship__icontains=request.GET.get('citizenship')
        )
    if request.GET.get('race'):
        filtered = True
        students = students.filter(
            race__icontains=request.GET.get('race')
        )
    ...
    if request.GET.get('starting_semester'):
        filtered = True
        students = students.filter(
            starting_semester=request.GET.get('starting_semester')
        )
    ...
    if request.GET.get('tofel_score'):
        filtered = True
        students = students.filter(
            tofel_score=request.GET.get('tofel_score')
        )
    if request.GET.get('sat_score'):
        filtered = True
        students = students.filter(
            sat_score=request.GET.get('sat_score')
        )
    if request.GET.get('greq_score'):
        filtered = True
        students = students.filter(
            greq_score=request.GET.get('greq_score')
        )
    if request.GET.get('grev_score'):
        filtered = True
        students = students.filter(
            grev_score=request.GET.get('grev_score')
        )
    if request.GET.get('grea_score'):
        filtered = True
        students = students.filter(
            grea_score=request.GET.get('grea_score')
        )
    if request.GET.get('gre_total_score'):
        filtered = True
        students = students.filter(
            gre_total_score=request.GET.get('gre_total_score')
        )
